...
Character (must remain identical across all scenes):
${dna}

Character interacting naturally with the product.
Realistic facial details and natural body posture.

Environment must remain consistent for all videos.
Lighting: ${globalStyle.lighting}
Color tone: ${globalStyle.color_tone}

This image will be used as master reference.
