...
`
  ...
  const imagePrompt = `
Buat gambar portrait rasio 9:16 (vertikal).
...
Karakter berinteraksi dengan produk:
"${input.product}"
...
Gaya realistis dan detail seperti foto  profesional.
Framing vertikal dan terpusat.
gambar harus terlihat detail,jelas dan tidak terpotong.
