export function getGlobalStyle(style) {
  ...
  const base = {
    ...
    character_lock: "same main character, same outfit across all scenes",
    location_lock: "same environment and background across all scenes"
  };
  ...
  const styles = {
    ...
    Luxury: {
      ...
      depth: "shallow depth, premium product focus",
